...
const stringifyISA = (v: ISA) => {
    const isaStrings = {
        ...
        [ISA.Motorola68K   ]: 'Motorola 68000',
        [ISA.Motorola88K   ]: 'Motorola 88000',
        [ISA.Intel860      ]: 'Intel 80860',
        [ISA.MIPS          ]: 'MIPS',
        [ISA.S370          ]: 'IBM System/370',
        [ISA.MIPS_RS3_LE   ]: 'MIPS RS3000 Little-endian',
        [ISA.PARISC        ]: 'HP PA-RISC',
        [ISA.VPP500        ]: 'Fujitsu VPP500',
        [ISA.SPARC32PLUS   ]: 'Enhanced SPARC',
        [ISA.Intel960      ]: 'Intel 80960',
        [ISA.PPC           ]: 'PowerPC',
        [ISA.PPC64         ]: 'PowerPC 64-bit',
        [ISA.S390          ]: 'IBM System/390',
        [ISA.V800          ]: 'NEC V800',
        [ISA.FR20          ]: 'Fujitsu FR20',
        [ISA.RH32          ]: 'TRW RH-32',
        [ISA.RCE           ]: 'Motorola RCE',
        [ISA.ARM           ]: 'ARM',
        [ISA.ALPHA         ]: 'Digital Alpha',
        [ISA.SH            ]: 'Hitachi SH',
        [ISA.SPARCV9       ]: 'SPARC V9',
        [ISA.TRICORE       ]: 'Siemens TriCore',
        [ISA.ARC           ]: 'Argonaut RISC Core',
        [ISA.H8_300        ]: 'Hitachi H8/300',
        [ISA.H8_300H       ]: 'Hitachi H8/300H',
        [ISA.H8S           ]: 'Hitachi H8S',
        [ISA.H8_500        ]: 'Hitachi H8/500',
        [ISA.IA_64         ]: 'Intel IA-64',
        [ISA.MIPS_X        ]: 'Stanford MIPS-X',
        [ISA.COLDFIRE      ]: 'Motorola ColdFire',
        [ISA.Motorola68HC12]: 'Motorola M68HC12',
        [ISA.MMA           ]: 'Fujitsu MMA Multimedia Accelerator',
        [ISA.PCP           ]: 'Siemens PCP',
        [ISA.NCPU          ]: 'Sony nCPU embeeded RISC',
        [ISA.NDR1          ]: 'Denso NDR1 microprocessor',
        [ISA.STARCORE      ]: 'Motorola Star*Core processor',
        [ISA.ME16          ]: 'Toyota ME16 processor',
        [ISA.ST100         ]: 'STMicroelectronics ST100',
        [ISA.TINYJ         ]: 'Advanced Logic Corp. TinyJ',
        [ISA.X86_64        ]: 'AMD x86-64',
        [ISA.PDSP          ]: 'Sony DSP Processor',
        [ISA.PDP10         ]: 'Digital Equipment Corp. PDP-10',
        [ISA.PDP11         ]: 'Digital Equipment Corp. PDP-11',
        [ISA.FX66          ]: 'Siemens FX66 microcontroller',
        [ISA.ST9PLUS       ]: 'STMicroelectronics ST9+ 8/16 bit microcontroller',
        [ISA.ST7           ]: 'STMicroelectronics ST7 8-bit microcontroller',
        [ISA.Motorola68HC16]: 'Motorola MC68HC16 Microcontroller',
        [ISA.Motorola68HC11]: 'Motorola MC68HC11 Microcontroller',
        [ISA.Motorola68HC08]: 'Motorola MC68HC08 Microcontroller',
        [ISA.Motorola68HC05]: 'Motorola MC68HC05 Microcontroller',
        [ISA.SVX           ]: 'Silicon Graphics SVx',
        [ISA.ST19          ]: 'Digital VAX',
        [ISA.CRIS          ]: 'Axis Communications 32-bit embedded processor',
        [ISA.JAVELIN       ]: 'Infineon Technologies 32-bit embedded processor',
        [ISA.FIREPATH      ]: 'Element 14 64-bit DSP Processor',
        [ISA.ZSP           ]: 'LSI Logic 16-bit DSP Processor',
        [ISA.MMIX          ]: 'Donald Knuth\'s educational 64-bit processor',
        [ISA.HUANY         ]: 'Harvard University machine-independent object files',
        [ISA.PRISM         ]: 'SiTera Prism',
        [ISA.AVR           ]: 'Atmel AVR 8-bit microcontroller',
        [ISA.FR30          ]: 'Fujitsu FR30',
        [ISA.D10V          ]: 'Mitsubishi D10V',
        [ISA.D30V          ]: 'Mitsubishi D30V',
        [ISA.V850          ]: 'NEC v850',
        [ISA.M32R          ]: 'Mitsubishi M32R',
        ...
        [ISA.TMM_GPP       ]: 'Thompson Multimedia General Purpose Processor',
        [ISA.NS32K         ]: 'National Semiconductor 32000 series',
        [ISA.TPC           ]: 'Tenor Network TPC processor',
        [ISA.SNP1K         ]: 'Trebia SNP 1000 processor',
        [ISA.ST200         ]: 'STMicroelectronics (www.st.com) ST200 microcontroller',
        [ISA.IP2K          ]: 'Ubicom IP2xxx microcontroller family',
        [ISA.MAX           ]: 'MAX Processor',
        [ISA.CR            ]: 'National Semiconductor CompactRISC microprocessor',
        [ISA.F2MC16        ]: 'Fujitsu F2MC16',
        [ISA.MSP430        ]: 'Texas Instruments embedded microcontroller msp430',
        [ISA.BLACKFIN      ]: 'Analog Devices Blackfin (DSP) processor',
        [ISA.SE_C33        ]: 'S1C33 Family of Seiko Epson processors',
        [ISA.SEP           ]: 'Sharp embedded microprocessor',
        [ISA.ARCA          ]: 'Arca RISC Microprocessor',
        [ISA.UNICORE       ]: 'Microprocessor series from PKU-Unity Ltd. and MPRC of Peking University',
    };
